...
Although GIN-IPA (see Fig.\,\ref{fig:ginipa_DC}) does not cause an increment in DSC in the models trained on Kispi-mial and dHCP, it produces a significant improvement in the model trained on Kispi-irtk when predicting on dHCP. The raise is mainly located in dGM, ventricles and BS. The average Dice passes \numrange[range-open-phrase=from\ ]{0.34}{0.54} (\qty{+58}{\percent}).
...
%Appendix \hyperref[app:SupplementaryTables]{B} (Tabs.\,\ref{tab:baseline_vs_ginipa_stats}--\ref{tab:ginipa_vs_combined_stats}).
%Tabs.\,\ref{tab:baseline_vs_ginipa_stats}--\ref{tab:ginipa_vs_combined_stats}.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/1_mial-irtk_DC_Ventr.png}\hspace{9pt}
...
\begin{figure}[htbp]
  ...
  \vspace{5pt}
  \includegraphics[width=0.455\textwidth]{figures/1_mial-dhcp_VS_cGM.png}\quad
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|c|c|c}
    \toprule
    \textbf{Metric} & \textbf{Label} & \makecell{\textbf{Mean perf.} \\ \textbf{variation}} & \textbf{Cohen's $\abs{d}$} \\
    \midrule
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.46\textwidth]{figures/2_irtk-mial_DC_Cereb.png} \\
  \vspace{10pt}
  \includegraphics[width=0.45\textwidth]{figures/2_irtk-mial_HD_cGM.png}\quad
  \includegraphics[width=0.46\textwidth]{figures/2_irtk-mial_HD_Cereb.png}
  \caption{GIN-IPA vs.\ combined DA: KDE plots of DSC (top) and HD95 (bottom) in cortical gray matter and cerebellum, from models trained on Kispi-irtk and inferring on Kispi-mial.}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|c|l|c|c|c}
    \toprule
    \textbf{Train DS} & \makecell{\textbf{Inference DS} \\ \textbf{(n.\ of samples)}} & \multicolumn{1}{c|}{\textbf{Metric}} & \makecell{\textbf{Mean perf.} \\ \textbf{variation}} & \textbf{$p$-value} & \textbf{Cohen's $\abs{d}$} \\
    \midrule
    \multirow{9}{*}{Kispi-mial}
      ...
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $75 \rightarrow 76$ & $0.94$ & $< 0.1$ \\
      &  & VS $(\times 10^{-2})$ & $0.5 \rightarrow 2.7$ & --- & --- \\
      &  & HD95 & $3.4 \rightarrow 2.6$ & $0.53$ & $0.2$ \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{dHCP \\ $(n=267)$}} & DSC $(\times 10^{-2})$ & $40 \rightarrow 44$ & $\ll 0.01^\ddagger$ & $0.2$ \\
      &  & VS $(\times 10^{-2})$ & $9.7 \rightarrow 8.7$ & $\ll 0.01^\ddagger$ & $0.2$ \\
      &  & HD95 & $46 \rightarrow 45$ & $0.25$ & $< 0.1$ \\
    \hline
    \multirow{9}{*}{Kispi-irtk}
      & \multirow{3}{*}{\makecell{Kispi-mial \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $63 \rightarrow 68$ & $\ll 0.01^\ddagger$ & $0.2$ \\
      &  & VS $(\times 10^{-2})$ & $5.1 \rightarrow 3.1$ & $\ll 0.01^\ddagger$ & $0.01$ \\
      &  & HD95 & $5.0 \rightarrow 4.4$ & $0.16$ & $0.1$ \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=8)$}} & DSC $(\times 10^{-2})$ & $89 \rightarrow 89$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $0.3 \rightarrow 0.1$ & $0.69$ & $< 0.1$ \\
      &  & HD95 & $1.0 \rightarrow 1.0$ & --- & --- \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{dHCP \\ $(n=267)$}} & DSC $(\times 10^{-2})$ & $34 \rightarrow 54$ & $\ll 0.01^\ddagger$ & $1.1^{***}$ \\
      &  & VS $(\times 10^{-2})$ & $112 \rightarrow 71$ & $\ll 0.01^\ddagger$ & $0.8^{***}$ \\
      &  & HD95 & $49 \rightarrow 38$ & $\ll 0.01^\ddagger$ & $0.6^{**}$ \\
    \hline
    \multirow{9}{*}{dHCP}
      & \multirow{3}{*}{\makecell{Kispi-mial \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $67 \rightarrow 69$ & $\ll 0.01^\ddagger$ & $< 0.1$ \\
      &  & VS $(\times 10^{-2})$ & $13 \rightarrow 6$ & $0.72$ & $0.1$ \\
      & & HD95 & $3.6 \rightarrow 3.2$ & $<0.01^\ddagger$ & $< 0.1$ \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $76 \rightarrow 77$ & $\ll 0.01^\ddagger$ & $0.1$ \\
      &  & VS $(\times 10^{-2})$ & $7.7 \rightarrow 6.7$ & $\ll 0.01^\ddagger$ & $< 0.1$ \\
      &  & HD95 & $2.7 \rightarrow 2.5$ & $< 0.01^\ddagger$ & $< 0.1$ \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{dHCP \\ $(n=53)$}} & DSC $(\times 10^{-2})$ & $95 \rightarrow 95$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $0.2 \rightarrow 0.1$ & $0.2^\dagger$ & $< 0.1$ \\
      &  & HD95 & $7.1 \rightarrow 7.0$ & $< 0.01^\ddagger$ & $< 0.1$ \\
    \bottomrule
  \end{tabular}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|c|l|c|c|c}
    ...
    \multirow{9}{*}{Kispi-mial}
      & \multirow{3}{*}{\makecell{Kispi-mial \\ $(n=8)$}} & DSC $(\times 10^{-2})$ & $83 \rightarrow 83$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $3.6 \rightarrow 4.1$ & --- & --- \\
      &  & HD95 & $1.6 \rightarrow 1.6$ & --- & --- \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $76 \rightarrow 76$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $2.7 \rightarrow 2.6$ & --- & --- \\
      &  & HD95 & $2.6 \rightarrow 2.7$ & --- & --- \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{dHCP \\ $(n=267)$}} & DSC $(\times 10^{-2})$ & $44 \rightarrow 44$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $87 \rightarrow 87$ & --- & --- \\
      &  & HD95 & $45 \rightarrow 44$ & $< 0.01^\ddagger$ & $< 0.1$ \\
    \hline
    \multirow{9}{*}{Kispi-irtk}
      & \multirow{3}{*}{\makecell{Kispi-mial \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $68 \rightarrow 72$ & $\ll 0.01^\ddagger$ & $0.2$ \\
      &  & VS $(\times 10^{-2})$ & $3.1 \rightarrow 6.9$ & --- & --- \\
      &  & HD95 & $4.4 \rightarrow 3.3$ & $\ll 0.01^\ddagger$ & $0.2^*$ \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=8)$}} & DSC $(\times 10^{-2})$ & $89 \rightarrow 89$ & --- & --- \\
    ...
    \multirow{9}{*}{dHCP}
      ...
      &  & HD95 & $3.2 \rightarrow 3.3$ & --- & --- \\
      \hhline{~-----}
      & \multirow{3}{*}{\makecell{Kispi-irtk \\ $(n=40)$}} & DSC $(\times 10^{-2})$ & $77 \rightarrow 77$ & --- & --- \\
      &  & VS $(\times 10^{-2})$ & $6.7 \rightarrow 5.7$ & $\ll 0.01^\ddagger$ & $< 0.1$ \\
...
\begin{figure}[htbp]
  ...
  \caption{Comparison of the segmentation performance by pathology, between the baseline and the GIN-IPA augmentation models. From top to bottom: Dice score, volume similarity \big(cropped, full range is $[-2, 2]$\big), and Hausdorff distance 95\th percentile. Until the bars are brown, the metrics of the two models are equivalent.}
...
\begin{figure}[htbp]
  ...
  \caption{Comparison of the segmentation performance by pathology, between the GIN-IPA and the combined augmentation models. From top to bottom: Dice score, volume similarity \big(cropped, full range is $[-2, 2]$\big), and Hausdorff distance 95\th percentile. Until the bars are brown, the metrics of the two models are equivalent.}
