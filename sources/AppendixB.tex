...
\begin{table}[h!]
    ...
    \begin{tabular}{c|c|l|c|c|c}
        ...
        \bottomrule
    \end{tabular}
    \caption{Baseline vs.\ GIN-IPA: mean performance variation, Wilcoxon \textit{p}-value and Cohen's |\textit{d}| across training/inference datasets and metrics. To improve comprehensibility, the absolute value of VS is shown. Where the \textit{p}-value and the Cohen's |\textit{d}| are missing, it is because the performance variation is either negative or negligible. ${ }^{\dagger}$: \textit{p}-value $< 0.05$; ${ }^{\ddagger}$: \textit{p}-value $<0.01$. ${ }^{*}$: $\abs{d}>0.2$; ${ }^{**}$: $\abs{d}>0.5$; ${ }^{***}$: $\abs{d}>0.8$.}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|c|l|c|c|c}
    ...
    \bottomrule
  \end{tabular}
  \caption{GIN-IPA vs.\ combined methods augmentation: mean performance variation, Wilcoxon \textit{p}-value and Cohen's |\textit{d}| across training/inference datasets and metrics. To improve comprehensibility, the absolute value of VS is shown. Where the \textit{p}-value and the Cohen's |\textit{d}| are missing, it is because the performance variation is either negative or negligible. ${ }^{\dagger}$: \textit{p}-value $< 0.05$; ${ }^{\ddagger}$: \textit{p}-value $<0.01$. ${ }^{*}$: $\abs{d}>0.2$; ${ }^{**}$: $\abs{d}>0.5$; ${ }^{***}$: $\abs{d}>0.8$.}
