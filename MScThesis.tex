...
\mainmatter
  ...
  %\include{sources/MethodsForFetalBrainSegmentation}

  \include{sources/TheFeTAChallenge}
  ...
  %\include{sources/Datasets}

  %\include{sources/Atlases}
  
  %\include{sources/Models}

  %\include{sources/TrainingAndTest}
